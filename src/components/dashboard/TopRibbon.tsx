...
import { PhoneCall, MessageSquare, Award, ArrowRight, AlertTriangle, TrendingDown, Clock } from 'lucide-react';
...
export const TopRibbon: React.FC<TopRibbonProps> = ({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      ...
      <div className="glass-card relative overflow-hidden rounded-2xl p-4 border border-red-500/30 hover:border-red-500/60 bg-gradient-to-br from-red-950/40 via-slate-900/60 to-slate-900/80 shadow-lg shadow-red-950/20">
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="text-right">
            ...
            <p className="text-[10px] text-slate-400 mt-0.5">Học viên</p>
          </div>
        </div>
        ...
        <div className="mt-4 pt-3 border-t border-slate-800/80 flex items-center justify-between gap-2">
          <button
            ...
            className="text-[11px] font-medium text-slate-400 hover:text-slate-200 underline underline-offset-2 transition-colors"
          >
            Lọc bảng HV này
          </button>
          <button
      ...
      <div className="glass-card relative overflow-hidden rounded-2xl p-4 border border-amber-500/30 hover:border-amber-500/60 bg-gradient-to-br from-amber-950/30 via-slate-900/60 to-slate-900/80 shadow-lg shadow-amber-950/10">
      ...
      <div className="glass-card relative overflow-hidden rounded-2xl p-4 border border-[#DB0829]/30 hover:border-[#DB0829]/60 bg-gradient-to-br from-[#DB0829]/20 via-slate-900/60 to-slate-900/80 shadow-lg shadow-[#DB0829]/10">
        <div className="absolute top-0 right-0 w-24 h-24 bg-[#DB0829]/15 rounded-full blur-2xl pointer-events-none" />
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
          ...
          <div className="text-right">
            ...
            <p className="text-[10px] text-slate-400 mt-0.5">Hồ sơ</p>
          </div>
        </div>
        ...
        <div className="mt-4 pt-3 border-t border-slate-800/80 flex items-center justify-end">
          ...
          >
            Đến Review Center <ArrowRight className="w-3.5 h-3.5" />
          </button>
        </div>
      </div>
    </div>
